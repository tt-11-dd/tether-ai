...
export interface DesktopApi {
  ...
  app: {
    ...
    /** Shows the update dialog. A newer release opens the download site. */
    checkUpdate(): Promise<void>;
    /** Set when the startup check finds a newer release, including if the renderer subscribed late. */
    updateNotice(): Promise<{ version: string } | undefined>;
