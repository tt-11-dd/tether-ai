...
const zh = {
  ...
  "update.detail": "当前平台没有可用的应用内安装包，请前往 GitHub Releases 手动下载。",
  "update.download": "下载更新",
  "update.later": "稍后",
  "update.checking": "正在检查更新…",
  "update.downloading": "正在下载 v{version}",
  "update.cancel": "取消下载",
  "update.busy": "已有下载任务在进行中。",
  "update.ready": "v{version} 已下载完成",
  "update.installRestart": "安装并重启",
  "update.installOpen": "打开安装包",
  "update.installing": "正在启动安装程序，Tether 即将退出。",
  "update.openedHint":
    "已在访达中打开磁盘映像，请把 Tether 拖入「应用程序」替换旧版本。",
  "update.notDownloaded": "还没有下载好的安装包。",
  "update.confirmInstall": "安装 Tether v{version}？",
  "update.confirmInstallDetail": "Tether 会退出，安装完成后会自动重新打开。",
  "update.manual": "前往 GitHub 下载",
  "update.hint": "更新包直接从 GitHub Releases 获取，不需要额外的更新服务器。",
  "update.readyMac": "下载完成。点「打开安装包」后在访达中把 Tether 拖入「应用程序」。",
  "update.readyWin": "下载完成。安装时 Tether 会退出，完成后自动重新打开。",
  "update.startupToast": "Tether v{version} 可用，可在「设置 → 关于」中更新。",
  ...
  "composer.queueSend": "立即发送",
  "composer.queuePaused": "队列已暂停",
  "composer.queueResume": "继续发送",
  ...
  "composer.upLevel": "上一级",
  "composer.refDir": "引用目录",
  "composer.hintNavigate": "选择",
  "composer.hintBack": "返回",
  "composer.hintEnter": "进入",
  "composer.hintRef": "引用",
  "composer.selectCurrentDir": "选择当前目录",
  ...
  "terminal.success": "成功",
  "terminal.showingTail": "已定位末尾报错日志（共 {n} 行）",
  ...
  "preview.empty": "（空文件）",
  "preview.missing": "当前项目里找不到这个文件（可能已删除，或属于其他项目）",
  "preview.missingPatch": "当前项目里找不到这个文件，下面显示的是本轮改动",
  ...
  "trace.fetch": "抓取网页",
  "trace.read": "读取",
  "trace.readN": "查阅 {n} 个文件",
  "trace.searchN": "执行 {n} 次搜索",
  "trace.file": "文件",
  "trace.workspace": "工作区",
  ...
  "error.noImage": "请先上传至少一张图片",
  "error.invalidImage": "图片数据无效，请重新选择",
  "error.imageTooLarge": "单张图片不能超过 {mb} MB",
  "error.needUrlAndKey": "请先填写 API URL 和 Key",
  "error.needApiUrl": "请先填写 API URL",
  "error.needApiKey": "请先填写 API Key",
  "error.invalidApiUrl": "API URL 无效",
  "error.httpOnly": "只支持 http(s) 地址",
  "error.notAFolder": "所选工作区不是文件夹",
  "error.noActiveSession": "当前没有进行中的会话",
  "error.folderNotOpened": "该文件夹不是已打开的项目",
  "error.pathOutsideWorkspace": "路径在工作区之外",
  "error.workspaceInaccessible": "无法访问该工作区路径",
...
const en: Record<MessageKey, string> = {
  ...
  "update.detail":
    "This platform has no in-app installer, so download it from GitHub Releases.",
  "update.download": "Download",
  "update.later": "Later",
  "update.checking": "Checking for updates…",
  "update.downloading": "Downloading v{version}",
  "update.cancel": "Cancel download",
  "update.busy": "A download is already running.",
  "update.ready": "v{version} is ready to install",
  "update.installRestart": "Install and restart",
  "update.installOpen": "Open installer",
  "update.installing": "Starting the installer; Tether will quit now.",
  "update.openedHint":
    "The disk image is open in Finder. Drag Tether into Applications to replace the old version.",
  "update.notDownloaded": "No downloaded installer yet.",
  "update.confirmInstall": "Install Tether v{version}?",
  "update.confirmInstallDetail":
    "Tether will quit and reopen when the install finishes.",
  "update.manual": "Download from GitHub",
  "update.hint":
    "Update packages come straight from GitHub Releases; no update server is involved.",
  "update.readyMac":
    "Downloaded. Click “Open installer”, then drag Tether into Applications in Finder.",
  "update.readyWin": "Downloaded. Tether quits during install and reopens afterwards.",
  "update.startupToast":
    "Tether v{version} is available — update it from Settings → About.",
  ...
  "toast.steerFailed": "Could not steer; the message is back in the queue",
  ...
  "composer.queueSend": "Send now",
  "composer.queuePaused": "Queue paused",
  "composer.queueResume": "Resume queue",
  ...
  "composer.upLevel": "Up",
  "composer.refDir": "Reference",
  "composer.hintNavigate": "Navigate",
  "composer.hintBack": "Back",
  "composer.hintEnter": "Open",
  "composer.hintRef": "Mention",
  "composer.selectCurrentDir": "Select current folder",
  ...
  "terminal.showingTail": "Showing tail error log ({n} lines)",
  ...
  "preview.missing": "This file is not in the current project (deleted, or from another project)",
  "preview.missingPatch": "This file is not in the current project; showing this turn's change instead",
  ...
  "trace.read": "Read",
  "trace.readN": "Read {n} files",
  "trace.searchN": "Ran {n} searches",
  "trace.file": "file",
  ...
  "error.noImage": "Upload at least one image first",
  "error.invalidImage": "That image data is invalid, pick it again",
  "error.imageTooLarge": "Each image must be under {mb} MB",
  "error.needUrlAndKey": "Fill in the API URL and key first",
  "error.needApiUrl": "Fill in the API URL first",
  "error.needApiKey": "Fill in the API key first",
  "error.invalidApiUrl": "Invalid API URL",
  "error.httpOnly": "Only http(s) addresses are supported",
  "error.notAFolder": "The selected workspace is not a folder",
  "error.noActiveSession": "No workspace session is active",
  "error.folderNotOpened": "Folder is not an opened project",
  "error.pathOutsideWorkspace": "Path outside workspace",
  "error.workspaceInaccessible": "Workspace path is not accessible",
