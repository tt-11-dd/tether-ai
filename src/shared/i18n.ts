...
const zh = {
  ...
  "composer.placeholderFollowup": "输入后续问题，结束后自动发送…",
  "composer.queued": "{n}/5 已排队",
  "composer.queueFull": "最多排队 5 条，等当前条发出后再发",
  "composer.sendQueue": "立即发送",
  "composer.bumpQueue": "提到下一条",
  "composer.editQueue": "编辑排队",
  "composer.dropQueue": "取消排队",
...
const en: Record<MessageKey, string> = {
  ...
  "composer.bumpQueue": "Send next",
  "composer.editQueue": "Edit queued message",
  "composer.dropQueue": "Remove from queue",
