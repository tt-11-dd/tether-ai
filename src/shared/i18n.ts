...
const zh = {
  ...
  "update.download": "前往官网下载",
  "update.later": "稍后",
  "update.ok": "好",
  "update.failed": "检查更新失败",
  "update.failedDetail": "请稍后重试，或前往官网下载。",
...
const en: Record<MessageKey, string> = {
  ...
  "update.detail": "Current version: v{current}\nDownload and install it from the website.",
  "update.download": "Open website",
  "update.later": "Later",
  "update.ok": "OK",
  "update.failed": "Update check failed",
  "update.failedDetail": "Try again later, or download it from the website.",
