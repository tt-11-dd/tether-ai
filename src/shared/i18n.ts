...
const zh = {
  ...
  "perm.plan": "仅规划",
  "perm.planDesc": "只分析和规划，不修改文件或运行命令。",
  "perm.ask": "编辑时询问",
  ...
  "about.subtitle": "面向开发者的开放式、本地优先 AI 编程工作台",
  "about.f1Title": "DeepSeek 深度优化",
  "about.f1Body": "：支持推理思考强度调节（High / Medium / Low）、思维链流式展示与长上下文大仓库解析。",
  "about.f2Title": "100% 开放自定义接口",
  "about.f2Body": "：自由接入 OneAPI、Ollama、vLLM、企业内部私有网关，无任何厂商闭源锁定。",
  "about.f3Title": "内置 MinerU OCR 引擎",
  "about.f3Body": "：无需 API Key 即可本地免费提取设计稿与报错截图中的高精度代码与 Markdown。",
  "about.f4Title": "纯粹本地优先与原子级撤销",
  "about.f4Body": "：所有会话和密钥存储于本机 ~/.tether，支持 /undo 事务级检查点一键还原。",
  "about.version": "应用版本",
  "about.core": "Agent 内核",
  "about.coreVal": "Tether Agent Core (本地隔离)",
  "about.arch": "运行架构",
  "about.sandbox": "沙箱状态",
  "about.sandboxVal": "已就绪 (macOS / Windows 隔离防护)",
...
const en: Record<MessageKey, string> = {
  ...
  "perm.plan": "Plan only",
  "perm.planDesc": "Analyze and plan only — no file edits or commands.",
  ...
  "about.subtitle": "Open, local-first AI coding workbench for developers",
  ...
  "about.f2Title": "100% open gateways",
  "about.f2Body": ": OneAPI, Ollama, vLLM, or private corp proxies — no vendor lock-in.",
  "about.f3Title": "Built-in MinerU OCR",
  "about.f3Body": ": Extract code and Markdown from designs and error screenshots locally, no API key.",
  "about.f4Title": "Local-first with atomic undo",
  "about.f4Body": ": Sessions and secrets stay in ~/.tether; /undo restores transactional checkpoints.",
  "about.version": "App version",
  "about.core": "Agent core",
  "about.coreVal": "Tether Agent Core (local)",
  "about.arch": "Runtime",
  "about.sandbox": "Sandbox",
  "about.sandboxVal": "Ready (macOS / Windows isolation)",
